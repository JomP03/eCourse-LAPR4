...
public class AddBooleanQuestionUI extends AbstractUI {

    private final AddBooleanQuestionController theController = new AddBooleanQuestionController(
    ...
    protected boolean doShow() {
        ...
        try {
            theController.addQuestion(widget.question, widget.quotation, widget.penalty, widget.correctOption);
